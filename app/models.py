...
class User(db.Model):
    ...
    # Security PIN for payments
    security_pin_hash = db.Column(db.String(255), nullable=True)
    pin_created_at = db.Column(db.DateTime, nullable=True)
    ...
    def has_pin(self):
        return self.security_pin_hash is not None
...
class FraudAlert(db.Model):
    ...
    fraud_type = db.Column(db.String(50), nullable=True)
...
class FraudTrainingData(db.Model):
    ...
    transaction_type = db.Column(db.String(20), nullable=False)
    amount = db.Column(db.Float, nullable=False)
    name_orig = db.Column(db.String(50), nullable=False)
    old_balance_orig = db.Column(db.Float, nullable=False)
    new_balance_orig = db.Column(db.Float, nullable=False)
    name_dest = db.Column(db.String(50), nullable=False)
    old_balance_dest = db.Column(db.Float, nullable=False)
    new_balance_dest = db.Column(db.Float, nullable=False)
    is_fraud = db.Column(db.Boolean, nullable=False)
    is_flagged_fraud = db.Column(db.Boolean, default=False)
    created_at = db.Column(db.DateTime, default=datetime.utcnow)
